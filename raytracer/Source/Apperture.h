...
class Apperture {
  public:
    ...
    Apperture( glm::vec4 v0, glm::vec4 v1, glm::vec4 v2, glm::vec4 v3, glm::vec4 v4, glm::vec4 v5, glm::vec3 colour )
...
void LoadAppertureHexagon(vector<Apperture> &hexagon) {
  ...
  hexagon.push_back(Apperture(A, B, C, D, E, F, vec3(0, 0, 1)));
